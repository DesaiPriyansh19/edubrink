  ...
  return (
    <>
      <div className="max-w-full mx-auto ">
       ...
       <Link to={'/searchresults/Allcorse'}>  <button className="hidden sm:block  shadow-sm hover:shadow-md text-black text-sm py-1 px-3 rounded-full">
            View All 
          </button></Link> 
        </div>
