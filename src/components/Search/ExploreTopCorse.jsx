...
import GradientSpinnerLoader, { BouncingBarsLoader, FullPageLoader } from "./Results/ImprovedLoaders"
                ...
                >
                  <div className="flex gap-2 sm:gap-3 items-center mt-6 sm:mt-2 mb-6 md:mb-3">
                    <div className="w-20 h-20">
                      <img
                        src={course?.university?.uniSymbol || "https://placehold.co/80x80" || "/placeholder.svg"}
                        alt="College Logo"
